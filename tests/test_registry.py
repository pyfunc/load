...
class TestRegistry:
    def test_list_registries(self):
        ...
        assert any('Company private' in reg['description'] for reg in private_registries)
    ...
    def test_configure_private_registry(self):
        ...
        assert test_name in PRIVATE_REGISTRIES
        assert PRIVATE_REGISTRIES[test_name]['index_url'] == 'https://test.pypi.org/simple/'
        ...
        assert PRIVATE_REGISTRIES[test_name + '_gitlab']['base_url'] == 'https://gitlab.test.org/'
    ...
    def test_install_from_gitlab(self):
        ...
        try:
            ...
            assert registry.install_from_gitlab('https://gitlab.com/user/repo', 'test-token') is True
